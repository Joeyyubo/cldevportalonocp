    ...
    <div>
      ...
      <div style={{ marginBottom: '32px' }}>
        <Grid hasGutter>
          <GridItem xl={4} lg={4} md={6} sm={12}>
            <Card isClickable onClick={() => setActiveTabKey('analytics')}>
              <CardBody>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <Icon>
                    <CogIcon color="var(--pf-v5-global--info-color--100)" />
                  </Icon>
                  <div>
          ...
          <GridItem xl={4} lg={4} md={6} sm={12}>
            <Card isClickable onClick={() => setActiveTabKey('logs')}>
              <CardBody>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <Icon>
                    <ClockIcon color="var(--pf-v5-global--warning-color--100)" />
                  </Icon>
                  <div>
                    <div style={{ fontSize: '16px', fontWeight: '500', marginBottom: '4px' }}>
                      Logs
                    ...
                    <div style={{ fontSize: '12px', color: 'var(--pf-v5-global--color--200)' }}>
                      Gateway and application logs for debugging
                    </div>
                  </div>
                </div>
              </CardBody>
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
          <Alert variant="warning" title="High CPU Usage" isInline>
            Gateway CPU usage is above 85% for the last 10 minutes
          </Alert>
          <Alert variant="info" title="Certificate Expiry" isInline>
      ...
      <div style={{ marginBottom: '32px' }}>
        <Title headingLevel="h4" size="sm" style={{ marginBottom: '16px' }}>
          Key Metrics Summary (Last 24 Hours)
        </Title>
        <Grid hasGutter>
          <GridItem xl={3} lg={3} md={6} sm={12}>
            <Card>
          ...
          <GridItem xl={3} lg={3} md={6} sm={12}>
            <Card>
              <CardBody>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '24px', fontWeight: 'bold', color: 'var(--pf-v5-global--danger-color--100)', marginBottom: '8px' }}>
                    0.3%
                  </div>
                  <div style={{ fontSize: '14px', color: 'var(--pf-v5-global--color--200)' }}>
                    Error Rate
    ...
    <>
      <PageSection variant="light">
        ...
        >
          ...
          <Tab eventKey="observability" title={<TabTitleText>Observability</TabTitleText>} />
